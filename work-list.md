...
1. 콘텐츠 관리 - 메인 캐러셀 상품의 추가 가능한 상품을 보기 좋고 찾기 좋게 수정

2. 카테고리 이미지 리서치 필요

3. 상품 상세페이지 이미지 배치 구조 생각해볼것 현재 너무 확대되어 화질이 안좋음

4. men 콘텐츠 내용 및 이미지 추가 해야함

5. home의 각 섹션 title 및 이벤트 배너 콘텐츠 내용 수정

6. 관리자 페이지 - 상품 관리 에서 상품 등록 일짜, 정렬 순서 등 유지보수가 편하게 수정 필요
