...
const rows = [
  ...
  { key: 'men.hero.image_tablet', page: 'men', label: '남성 히어로 이미지 (태블릿)', value: '' },
  ...
  { key: 'women.hero.image_tablet', page: 'women', label: '여성 히어로 이미지 (태블릿)', value: '' },
  { key: 'women.hero.image_desktop', page: 'women', label: '여성 히어로 이미지 (데스크톱)', value: '' },

  { key: 'men.editorial_banner.title', page: 'men', label: 'MEN 에디토리얼 타이틀', value: 'THE NEW TAILORING' },
  { key: 'men.editorial_banner.subtitle', page: 'men', label: 'MEN 에디토리얼 설명', value: '' },
  { key: 'men.editorial_banner.button_label', page: 'men', label: 'MEN 에디토리얼 버튼 문구', value: '컬렉션 보기' },
  { key: 'men.editorial_banner.link_destination', page: 'men', label: 'MEN 에디토리얼 버튼 이동 페이지', value: 'men' },
  { key: 'men.editorial_banner.link_category', page: 'men', label: 'MEN 에디토리얼 버튼 이동 카테고리', value: 'all' },
  { key: 'men.editorial_banner.link_subcategory', page: 'men', label: 'MEN 에디토리얼 버튼 이동 세부 카테고리', value: '' },
  { key: 'men.editorial_banner.enabled', page: 'men', label: 'MEN 에디토리얼 노출 여부', value: 'false' },
  { key: 'men.editorial_banner.image_mobile', page: 'men', label: 'MEN 에디토리얼 모바일 이미지', value: '' },
  { key: 'men.editorial_banner.image_tablet', page: 'men', label: 'MEN 에디토리얼 태블릿 이미지', value: '' },
  { key: 'men.editorial_banner.image_desktop', page: 'men', label: 'MEN 에디토리얼 데스크톱 이미지', value: '' },

  { key: 'women.editorial_banner.title', page: 'women', label: 'WOMEN 에디토리얼 타이틀', value: 'THE NEW TAILORING' },
  { key: 'women.editorial_banner.subtitle', page: 'women', label: 'WOMEN 에디토리얼 설명', value: '' },
  { key: 'women.editorial_banner.button_label', page: 'women', label: 'WOMEN 에디토리얼 버튼 문구', value: '컬렉션 보기' },
  { key: 'women.editorial_banner.link_destination', page: 'women', label: 'WOMEN 에디토리얼 버튼 이동 페이지', value: 'women' },
  { key: 'women.editorial_banner.link_category', page: 'women', label: 'WOMEN 에디토리얼 버튼 이동 카테고리', value: 'all' },
  { key: 'women.editorial_banner.link_subcategory', page: 'women', label: 'WOMEN 에디토리얼 버튼 이동 세부 카테고리', value: '' },
  { key: 'women.editorial_banner.enabled', page: 'women', label: 'WOMEN 에디토리얼 노출 여부', value: 'false' },
  { key: 'women.editorial_banner.image_mobile', page: 'women', label: 'WOMEN 에디토리얼 모바일 이미지', value: '' },
  { key: 'women.editorial_banner.image_tablet', page: 'women', label: 'WOMEN 에디토리얼 태블릿 이미지', value: '' },
  { key: 'women.editorial_banner.image_desktop', page: 'women', label: 'WOMEN 에디토리얼 데스크톱 이미지', value: '' },
