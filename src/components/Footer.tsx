...
function Footer() {
  return (
    <footer className="mt-auto bg-inverse text-surface">
      <div className="flex flex-wrap gap-48 px-20 pb-32 pt-64 md:px-32 lg:px-80 xl:px-140 2xl:px-200">
      ...
      <div className="text-caption border-t border-white/15 px-20 py-16 text-disabled md:px-32 lg:px-80 xl:px-140 2xl:px-200">
